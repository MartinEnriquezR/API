...
class Cuestionario(models.Model):
    ...
    violencia = models.CharField(max_length=25, blank=True, null=True)
    acompanar = models.CharField(max_length=40, blank=True, null=True)
    denuncia_previa = models.CharField(max_length=2, blank=True, null=True)
    manejaba_auto = models.CharField(max_length=5, blank=True, null=True)
    ...
    entidad_denuncia = models.CharField(max_length=50, blank=True, null=True)
