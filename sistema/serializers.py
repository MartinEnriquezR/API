...
"""Serializer para que el contacto de confianza vea la ultima alerta de un grupo"""
...
class cuestionarioCrearSerializer(serializers.Serializer):
    ...
    violencia = serializers.CharField(max_length=25,allow_blank=True)
    acompanar = serializers.CharField(max_length=40,allow_blank=True)
    denuncia_previa = serializers.CharField(max_length=2,allow_blank=True)
    manejaba_auto = serializers.CharField(max_length=5,allow_blank=True)
    ...
    #campos restantes
    fecha_denuncia = serializers.DateField(allow_null=True)
    entidad_denuncia = serializers.CharField(max_length=50,allow_blank=True)
    ...
    def validate(self,data):
        ...
        if diferencia < timedelta(minutes=10):
            raise serializers.ValidationError('Aun no puedes responder este cuestionario.')
    ...
    def create(self,data):
        ...
        #quitar excedente de informacion
...
class cuestionarioActualizarSerializer(serializers.Serializer):
    ...
    def create(self,data):
        ...
        cuestionario.fecha_denuncia = data['fecha_denuncia']
        cuestionario.entidad_denuncia = data['entidad_denuncia']
