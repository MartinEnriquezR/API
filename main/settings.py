...
#librerias para la configuracion de la base de datos en heroku
...
#modificado para el deploy en heroku
DEBUG = False

#host de Heroku y el localhost
...
EMAIL_HOST_PASSWORD = 'g4b29E9hAxZoxF'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
...
#configuraciones de heroku para los archivos estaticos

STATICFIELDS_DIRS = {
    os.path.join(BASE_DIR,'static')
}

#guardar los archivos estaticos del sitio para el admin site
STATIC_ROOT = os.path.join(BASE_DIR,'staticfiles')

#almacenamiento de los archivos estaticos
